...
def main():
    ...
    parser.add_argument(
        '-e', '--experiment',
        type=str,
        default='experiment_reduction.py',
        help='Name of the experiment script to run. Default: experiment_reduction.py.'
    )
    parser.add_argument(
        '--csv',
        type=str,
    ...
    try:
        ...
        with open(args.csv, newline='') as csvfile:
            ...
            for row in reader:
                ...
                # Build the command to run experiment_reduction.py
                command = [
                    'python', args.experiment,
                    '-d', dataset,
                    '-o', output,
                    '-t', target,
                    '--seed', '2025'
